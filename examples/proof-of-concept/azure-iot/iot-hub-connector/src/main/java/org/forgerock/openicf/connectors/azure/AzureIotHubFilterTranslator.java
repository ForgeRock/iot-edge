 ...
 * <p>
 * If the AzureIotHub doesn't support a certain expression type, that factory
 ...
 */
public class AzureIotHubFilterTranslator extends AbstractFilterTranslator<Filter> {
