 ...
 * /oauth2/access_token
 * Request 1: (POST) Authenticate using client assertion
 * 1.  Set URI         ->  $am_host
...
String client_assertion = request.form.client_assertion?.getAt(0)
String authData = """{
   \"callbacks\": [
       {
...
String scope = request.form.scope?.getAt(0)
...
String scopeString = """[\"$parameter\", \"$value\"]""" as String
String thingsData = """{
  \"scope\": $scopeString
}""" as String
