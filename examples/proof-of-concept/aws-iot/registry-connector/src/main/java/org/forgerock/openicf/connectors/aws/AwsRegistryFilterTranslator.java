 ...
 * <p>
 * If the AWS Registry doesn't support a certain expression type, that factory
 ...
 */
public class AwsRegistryFilterTranslator extends AbstractFilterTranslator<Filter> {
