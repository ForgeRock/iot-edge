...
attributeTypes: ( 1.3.6.1.4.1.36733.2.2.1.26 NAME 'fr-idm-managed-client-custom-attrs' EQUALITY caseIgnoreJsonQueryMatch SYNTAX 1.3.6.1.4.1.36733.2.1.3.1 SINGLE-VALUE X-STABILITY 'Internal' X-ORIGIN 'OpenAM' )
attributeTypes: ( 1.3.6.1.4.1.36733.2.2.1.27 NAME 'fr-oauth2-client' EQUALITY caseIgnoreJsonQueryMatch SYNTAX 1.3.6.1.4.1.36733.2.1.3.1 SINGLE-VALUE X-STABILITY 'Internal' X-ORIGIN 'OpenAM' )
-
add: objectClasses
...
objectClasses: ( 1.3.6.1.4.1.36733.2.2.2.21 NAME 'fr-client' DESC 'Auxiliary class for ForgeRock Client Identity attributes'
 SUP top AUXILIARY MAY ( fr-idm-managed-client-custom-attrs $ fr-oauth2-client ) X-ORIGIN 'OpenAM' )
EOF